...
class Convenio{
    ...
    /**
        ...
        @param $pathParams {Array} Array de parÃ¡metros.
        @param $queryParams {Array} Array de parÃ¡metros.
        @param $body {Object} Cuerpo de la peticiÃ³n.
        @param $usuario {Usuario} Usuario que realiza la peticiÃ³n.
     * */
    ...
    function get($pathParams, $queryParams, $usuario){
        if (isset($pathParams[0]) && !empty($pathParams[0]) && is_numeric($pathParams[0])) {
            // Si hay un ID de convenio v¨¢lido en la URL, obtener y mostrar datos de ese convenio
            $resultado = DAOConvenio::mostrarDatosConvenio($pathParams[0]);
        } else {
            // Si no hay un ID de convenio v¨¢lido, mostrar todos los convenios
    ...
    /**
        ...
        @param $pathParams {Array} Array de par¨¢metros.
        @param $queryParams {Array} Array de par¨¢metros.
        @param $body {Object} Cuerpo de la petici¨®n.
        @param $usuario {Usuario} Usuario que realiza la petici¨®n.
     * */
