...
class DAOTarea{
	...
	**/
	public static function verTareasDeAlumno($idAlumno){
		...
		$sql .= 'JOIN Curso_Modulo ON (Modulo.id = Curso_Modulo.id_modulo AND Curso_Modulo.id_curso = Alumno.id_curso)';
	...
	**/
	public static function verTareaDeAlumno($idTarea, $idAlumno){
		...
		$sql .= 'JOIN Alumno ON Alumno.id_curso = Curso_Modulo.id_curso AND Alumno.id = Tarea.id_alumno ';
	...
	**/
	public static function verTareasDeAlumnoComoProfesor($id_alumno, $id_profesor){
		...
		$sql .= ' CASE ';
    	$sql .= ' WHEN DATEDIFF(NOW(), Tarea.fecha_fin) > 10 THEN 2 ';
        $sql .= ' WHEN DATEDIFF(NOW(), Tarea.fecha_fin) > 7 THEN 1 ELSE 0 ';
